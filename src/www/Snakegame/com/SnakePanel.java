...
public class SnakePanel extends JPanel implements KeyListener,ActionListener{
    ...
    // 定义七个图片变量，代表七张图片
    ImageIcon up = new ImageIcon("c:\\pic\\up.png"); // 向上的蛇头
    ImageIcon down = new ImageIcon("c:\\pic\\down.png"); // 向下的蛇头
    ImageIcon left = new ImageIcon("c:\\pic\\left.png"); // 向左的蛇头
    ImageIcon right = new ImageIcon("c:\\pic\\right.png"); // 向右的蛇头
    ImageIcon food = new ImageIcon("c:\\pic\\food.png");  // 食物
    ImageIcon body = new ImageIcon("c:\\pic\\body.png");  // 蛇的身体
    ImageIcon title = new ImageIcon("c:\\pic\\title.jpg"); // 游戏界面的主题
    ImageIcon di = new ImageIcon("c:\\pic\\di.png");//背景图片   
    ...
    int foodx = rand.nextInt(33)*25+50; //此处的数值根据自己设计的游戏界面的大小来确定
    int foody = rand.nextInt(23)*25+100;
    ...
    Timer timer = new Timer(170,this); // 每100毫秒调用一次ActionPerformed
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (direction.equals("R")){
            ...
            if (snakex[0] == foodx && snakey[0] == foody){  // 吃食物
                    len ++;
                    score ++;
                    foodx = rand.nextInt(33)*25+50;
                    foody = rand.nextInt(23)*25+100;
            }
